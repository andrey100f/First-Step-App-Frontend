...
const reducer: (state: AnnouncementItemState, action: ActionProps) => AnnouncementItemState =
    (state, {type, payload}) => {
        switch (type) {
            case FETCHING_STARTED:
                return { ...state, fetching: true, fetchingError: null };
            case FETCHING_SUCCEEDED:
                return { ...state, announcements: payload.announcements, fetching: false};
...
export const AnnouncementItemContext = React.createContext<AnnouncementItemState>(initialState);
